...
export class SeedConfig {
   ...
   * @type {string}
   */
  APP_CLIENT = argv['APP_CLIENT'] || 'pog'; // sg
  ...
  /**
   * The base folder for built shared.
   * @type {string}
   */
  SHARED_SRC = 'src/shared/';
  
  DEV_SHARED_DEST = `${this.DIST_DIR}/dev/shared`;

  PROD_SHARED_DEST = `${this.DIST_DIR}/prod/shared`;
  
  TEST_SHARED_DEST=`${this.DIST_DIR}/test/shared`;
