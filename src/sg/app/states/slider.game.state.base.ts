        ...
        if (!this.assetsLoaded) {
            ...
            if (!this.loadErrorFlag) {
                ...
                if (domain == 'localhost:5555' || domain == 'www-review-cert-tc1.thinkcentral.com'){
                    ...
                    testing_graphic.lineStyle(5, 0xF9825B, 1);
                    testing_graphic.drawRect(0, 0, 375, 60);
                    testing_graphic.endFill();

                    let testingtext = this.game.add.bitmapText(10, 7, 'AP_Black',"Star Threshold: "+
                    this.gameData.jsonData.levelData[this.levelIndex].scoring.starThreshold, 45);
                    testingtext.tint = 0x000000;
                //console.log('this',this.gameData.jsonData.levelData[this.levelIndex].scoring.starThreshold);
                

                    let QAtitle = this.game.add.bitmapText(82, -45, 'AP_Black', 'QA Purpose', 40);
                    QAtitle.tint = 0x000000;
                    let testing_Sprite = this.game.add.sprite(30, 1325);
                    testing_Sprite.addChild(testing_graphic);
                    testing_Sprite.addChild(testingtext);
